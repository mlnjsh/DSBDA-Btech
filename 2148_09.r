#Given the text of teenagers' Social Networking Service (SNS) pages, we can identify
#groups that share common interests such as sports, religion, or music. Clustering
#can automate the process of discovering the natural segments in this population.
#However, it will be up to us to decide whether or not the clusters are interesting
#and how we can use them for advertising.
#For this analysis, we will be using a dataset representing a random sample of 30,000
...
#was collected, the SNS was a popular web destination for U.S. teenagers. Therefore,
